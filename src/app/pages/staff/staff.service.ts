...
export interface Staff { id: string; first_name: string; last_name: string; employment_date: string | null; designation: Designation; phone_number: string | null; residence: string | null; permit_number: string | null; permit_expiry_date: string | null; date_of_birth: string | null; gender: 'Male' | 'Female' | null; attachment_name: string | null; attachment_data: string | null; status: 'Active' | 'Inactive'; created_at: string; }
